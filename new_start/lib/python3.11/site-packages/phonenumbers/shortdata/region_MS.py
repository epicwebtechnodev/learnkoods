...
PHONE_METADATA_MS = PhoneMetadata(id='MS', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[29]\\d\\d', possible_length=(3,)),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='211|9(?:11|88|99)', example_number='211', possible_length=(3,)),
    short_data=True)
